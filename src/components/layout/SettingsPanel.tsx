...
export default function SettingsPanel({ settings, onSettingsChange, onClose, embedded = false }: SettingsPanelProps) {
  ...
  const content = (
    <div className="space-y-5">
      ...
      <div className="text-center text-xs text-slate-500">
        <p className="font-semibold text-slate-400">AstroPlan v0.2.0</p>
  ...
  if (embedded) {
    return <div className="bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl p-6 border border-slate-700/50">{content}</div>;
  }
